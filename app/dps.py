from app.engravings import engrav_dict
from app.computation import get_multiplier

class final_dps:
    # def __init__(self, engrav1=None, engrav2=None, engrav3=None, engrav4=None,
    #              engrav5=None, engrav6=None, engrav1_lvl=None, engrav2_lvl=None, 
    #              engrav3_lvl=None, engrav4_lvl=None, engrav5_lvl=None, engrav6_lvl=None,
    #              c_rate=0, c_dmg=200, damage=1):
